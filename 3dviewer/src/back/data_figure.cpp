...
// Figure::Figure(const Figure &var) {
//   for (auto &edge : var._edges) {
//     _edges.push_back(edge);
//   }
//   for (auto &index : var._indices) {
//     _indices.push_back(index);
//   }
//   for (auto &vertex : var._vertices) {
//     _vertices.push_back(vertex);
//   }

// }
// Figure &Figure::operator=(const Figure &var) {
//   if (this != &var) {
//     for (auto &vertex : var._vertices) {
//       _vertices.push_back(vertex);
//     }
...
std::vector<Point3D> Figure::GetPoints() {
...
float Camera::GetScaleNormalisedFactor() const {
  // return 1.0f - scaleFactor / 100.0f;
  return scaleFactor / 100.0f;
}
